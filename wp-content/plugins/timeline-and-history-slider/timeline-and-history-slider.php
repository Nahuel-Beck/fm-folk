...
if( ! defined('WPOSTAHS_VERSION') ) {
	define( 'WPOSTAHS_VERSION', '2.0.5' ); // Plugin version
}
...
if(!defined( 'WPOSTAHS_PLUGIN_UPGRADE' ) ) {
	define('WPOSTAHS_PLUGIN_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/timeline-history-slider/?utm_source=WP&utm_medium=Timeline&utm_campaign=Upgrade-PRO'); // Plugin Check link
}
